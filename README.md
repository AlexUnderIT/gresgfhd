...
Уже опытный пользователь? Просто отредактируйте данный **README** файл по своему усмотрению.  
...
```
git clone https://gitflic.ru/project/adminuser@admin.local/ngruebgug.git
cd ngruebgug
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/adminuser@admin.local/ngruebgug.git
git clone
